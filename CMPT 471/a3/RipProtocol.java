...
class Router{
	...
	public boolean updateRoutingTable(HashMap<String, Integer> routes, String router_name){
		...
		for(int i=0; i<recDest.length; i++){
			if(!(routingTable.containsKey(recDest[i]))){//situation 1
				// System.out.println("Adding: "+recDest[i]);
				// System.out.println(routingTable.containsKey("N1"));
